...
def generate_records(length_of_name, list_of_domains, total_records, list_of_quotes):
    with open("data.txt", "w") as to_write:
        ...
        to_write.write("secondSearchingName123@example.com:Test value\n")
        to_write.write("secondSearchingName@example.com:Example value\n")

generate_records(10, list_of_domains, 10, quotes)